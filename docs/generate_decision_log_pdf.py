...
output_path = project_root / "docs" / "decision-log.pdf"
...
styles.add(ParagraphStyle(name='CustomTitle', parent=styles['Title'], fontSize=18, leading=22, alignment=1, spaceAfter=12))
styles.add(ParagraphStyle(name='CustomHeading2', parent=styles['Heading2'], fontSize=12, leading=16, spaceBefore=10, spaceAfter=6, textColor='#1f2937'))
styles.add(ParagraphStyle(name='CustomBody', parent=styles['BodyText'], fontSize=10.5, leading=14, spaceAfter=6))
